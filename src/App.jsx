...
function App() {
  ...
  return (
    <div className=" bg-[#1E1E1E] w-[100%] min-h-[100vh] text-white font-Didact Gothic">
      ...
      <div className="flex flex-col lg:flex-row px-2 lg:pl-[64.81px] mt-[85.83px] gap-[67.94px] lg:gap-[250px]">
        <div className="flex flex-col w-[100%] lg:w-[473.83px]">
          ...
          <div className=" leading-[28px] font-light mt-[14.34px]">
            You deserve a space to share your stories, essays and photography
            with the world. So we built rockie to help you make your time and
            work as much of an investment as possible.
          </div>
